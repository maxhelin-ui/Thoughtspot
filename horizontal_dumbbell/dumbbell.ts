...
// Bundle Highcharts (+ more + dumbbell module) from npm — NEVER the
// code.highcharts.com CDN, which 403s in headless/export contexts and leaves
// Highcharts undefined → "Cannot display the custom chart". See LESSONS.md.
